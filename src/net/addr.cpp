...
int addr::resolve_client(std::string_view host, std::string_view port, addr_option opt) noexcept{
...
int addr::resolve_server(std::string_view port, addr_option opt) noexcept{
    std::string port_str = std::string(port);
...
std::expected <addr, error_code> get_addr_server(
    std::string_view port, addr_option opt
){
    addr ret;
...
std::expected <addr, error_code> get_addr_client(
    std::string_view host, std::string_view port, addr_option opt
){
    addr ret;
